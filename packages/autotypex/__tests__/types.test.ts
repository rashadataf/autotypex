...
describe("inferType", () => {
    it("should infer types for a simple object", () => {
        ...
        expect(inferType(obj, "UserType")).toBe(expectedType);
    });
    ...
    it("should infer types for nested objects", () => {
        ...
        expect(inferType(obj, "NestedType")).toBe(expectedType);
    });
    ...
    it("should infer types for arrays", () => {
        ...
        expect(inferType(obj, "ArrayType")).toBe(expectedType);
    });
    ...
    it("should handle empty arrays as any[]", () => {
        ...
        expect(inferType(obj, "EmptyArrayType")).toBe(expectedType);
    });
    ...
    it("should handle null values", () => {
        ...
        expect(inferType(obj, "NullType")).toBe(expectedType);
    });
    ...
    it("should handle mixed types in an array (use first type)", () => {
        ...
        expect(inferType(obj, "MixedArrayType")).toBe(expectedType);
    });
